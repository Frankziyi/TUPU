...
def inception_v3(inputs,
  ...
  with tf.variable_scope(scope, 'InceptionV3', [inputs, num_classes],
    ...
    with slim.arg_scope([slim.conv2d], normalizer_fn=slim.batch_norm), slim.arg_scope([slim.batch_norm, slim.dropout],
  ...
  with tf.variable_scope('AuxLogits',reuse=reuse):
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                        stride=1, padding='SAME'):
  ...
  with tf.variable_scope('Logits',reuse=reuse):
    ...
    # 2048
    logits = slim.conv2d(net, num_classes, [1, 1], stride=1, padding='SAME', activation_fn=None,
