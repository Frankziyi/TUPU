  ...
  with tf.variable_scope(scope, 'resnet_v1', [inputs], reuse=reuse) as sc:
    ...
    with slim.arg_scope([slim.conv2d, bottleneck,
      ...
      with slim.arg_scope([slim.batch_norm], is_training=is_training,
        ...
        if config["taskType"] in ["videoAnalysis"]:
          ...
          if kwargs["asoftmax"]:
            ...
            # l2-normalized
            net = utils.normalized_fully_connected(fc5, num_classes,
                                                   scope="logits")
          else:
            net = slim.fully_connected(fc5, num_classes,
                                       activation_fn=None,
                                       scope="logits")
        else:
...
def resnet_v1_50(inputs,
  ...
  return resnet_v1(inputs, blocks, num_classes, is_training,
                   ...
                   include_root_block=True, reuse=reuse, scope=scope, **kwargs)
