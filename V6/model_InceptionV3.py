...
class pre_trained_inception_v3:
    def __init__(self, model_dir):
        ...
        _, self.end_points = inception_v3.inception_v3(self.inputs, is_training=False, num_classes=1501, batch_size = self.batch, scope="InceptionV3")
        self.model_dir = model_dir
        # A TensorFlow Session for use in interactive contexts, such as a shell.
        self.sess = tf.InteractiveSession()
        variables_to_restore = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='InceptionV3')
